...
public class PozycjaReceptyController {
    ...
    public ResponseEntity<PozycjaRecepty> updatePozycja(@PathVariable("id") Long id, @org.springframework.web.bind.annotation.RequestBody PozycjaRecepty updatedPozycja) {
        return pozycjareceptyRepository.findById(id)
                .map(pozycja -> {
